...
* **Domotics & Smart Home Engineering:** Managed tech entrepreneurship projects focusing on professional smart home integration, sensor networks, and customized control systems.
...
| :--- | :--- |
| **Hardware / EDA** | KiCad, Schematic Capture, Multi-layer PCB Routing, Component Selection, BOM Optimization |
| **Firmware & Code** | C, C++, Verilog, Python, Embedded C |
| **Hardware Platforms** | ESP32, STM32, Arduino ecosystem, FPGAs |
| **Automation & Control** | Industrial PLCs, H-Bridge Motor Control, Sensor Integration (I2C, SPI, RS485), Telemetry |
